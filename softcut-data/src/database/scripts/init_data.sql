...
INSERT INTO audio (file_name, description, path, extension, genre, added_on)
Select 'Bug Snag', 'Getting used to the added Width.', '/Metal', '.mp3', @MetalGenreID, current_date
WHERE NOT EXISTS (SELECT * FROM audio WHERE file_name = 'Bug Snag' LIMIT 1);
